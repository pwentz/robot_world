...
class RobotWorldTest < Minitest::Test
  ...
  def test_robot_world_creates_and_holds_robots
    ...
    assert robot_world.all.all?{|obj| obj.is_a?(RobotWorld::Robot)}
  end
  ...
  def test_robot_world_finds_and_returns_robots
    ...
    new_robot = robot_world.find(1)

    assert_instance_of RobotWorld::Robot, new_robot
